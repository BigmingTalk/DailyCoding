 ...
 * 题目: 给定两个字符串str1和str2,再给定三个整数ic, dc和rc,分别代表插入,删除和替换
 *      一个字符的代价,返回将str1编辑成str2的最小代价.
 * 难度: ***
 * 思路: 用二维矩阵dp来表示,dp[i][j]表示str1[0..i-1]编辑成str2[0..j-1]的最小代价.
 *
 */
public class Problem_09_EditCost_me {
