 ...
 * 题目: 给定一个字符串数组strs, 再给定两个字符串str1和str2, 返回在strs中
 *      str1与str2的最小距离,如果str1或str2为null, 或不在strs中,返回-1;
 * 举例: strs= ["1","3","3","3","2","3","1"], str1 = "1", str2 ="2",
 *      返回2.
 * 进阶题目: 如果查询发生的次数有很多,如何把每次查询的时间复杂度降为O(1).
 * 难度: **
 *
 */
public class Problem_12_MinDistance_me {
