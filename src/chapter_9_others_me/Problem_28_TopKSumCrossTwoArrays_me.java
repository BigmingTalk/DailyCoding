 ...
 * 题目: 两个有序数组相加和的TOP K问题
 *      给定两个有序数组arr1和arr2, 再给定一个整数k, 返回来自arr1和arr2
 *      的两个数相加和最大的前k个, 两个数必须分别来自两个数组.
 * 要求: 时间复杂度达到O(klongk)
 * 难度: **
 */
public class Problem_28_TopKSumCrossTwoArrays_me {
    ...
    public static void heapInsert(HeapNode[] heap, int index, int row,
                                  int col, int value) {
